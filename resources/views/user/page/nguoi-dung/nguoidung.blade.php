                            ...
                            <div class="rows">
                                <div class="col_large_default large-image" style="text-align: center;" >
                                  <a href="" data-toggle="modal" data-target="#ImageModal"> 
                                   <img style=" border: 1px #d4d4d4 solid; padding: 10px;border-radius:50%;-moz-border-radius:50%; -webkit-border-radius:50%;" class="img-responsive col-md-8" src="{!!asset('assetsUser/images/'.$user->hinh_dai_dien)!!}" data-zoom-image="https://bizweb.dktcdn.net/100/286/794/products/1-3.jpg?v=1517327927920"/>
                                  </a>
                                  </div>
                ...
                <div class="modal-body">
                 @csrf
                    <div>
                        ...
                        <img id="FileImg" src="{!!asset('assetsUser/images/'.$user->hinh_dai_dien)!!}" alt="profile image"  style=" border: 1px #d4d4d4 solid; padding: 10px;border-radius:50%;-moz-border-radius:50%; -webkit-border-radius:50%; max-width: 200px; marign: top 20px; max-height: 200px;">
                    </div>
					</div>
                    <div class="modal-footer">
